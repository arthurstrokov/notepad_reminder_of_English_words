...
import aiohttp
import time
from service import load_data_from_json
...
async def get_a_word_translation(not_translated_words):
    ...
    async with aiohttp.ClientSession() as session:        
        tasks = [asyncio.ensure_future(get_a_word_translation_from_abbyy_api(word, session, token)) for word in not_translated_words]
